...
if(isset($_POST['edit_fripturi'])){
    ...
    $query = "UPDATE fripturi SET  Name_Food='{$_POST["Name_Food"]}', Price='{$_POST["Price"]}'
    ...
    <div class="alert alert-primary" role="alert">
      ...
      ?></div></p>
        ...
        {   
            ...
            $menu = "SELECT * FROM fripturi WHERE ID_Food='$food_id'";
      ...
      <button type="submit" class="btn btn-success" name="edit_fripturi">Edit</button>
    </form>  
                        <?php
                    }
            }
